...
export default function AppLayout() {
  ...
  return (
    <div className={`app-layout${sidebarCollapsed ? ' sidebar-collapsed' : ''}${mobileOpen ? ' menu-open' : ''}`}>
      ...
      <div className="mobile-topbar-bar" aria-hidden="true" />
      ...
      {/* Mobile overlay — toujours dans le DOM, fade via CSS pour éviter artefact Safari */}
      <div className={`sidebar-overlay${mobileOpen ? ' sidebar-overlay--open' : ''}`} onClick={() => setMobileOpen(false)} />
