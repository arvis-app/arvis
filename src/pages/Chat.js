        ...
        <div style={{ position: 'relative', flexShrink: 0, paddingBottom: 10 }}>
          {showLeftArrow && (
            <button onClick={() => scrollChips(-1)} aria-label="Zurück"
              style={{ position: 'absolute', left: -2, top: 0, bottom: 10, width: 44, zIndex: 2, border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(to right, var(--bg) 70%, transparent)', borderRadius: 0, padding: 0 }}>
          ...
          {showRightArrow && (
            <button onClick={() => scrollChips(1)} aria-label="Weiter"
              style={{ position: 'absolute', right: -2, top: 0, bottom: 10, width: 44, zIndex: 2, border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(to left, var(--bg) 70%, transparent)', borderRadius: 0, padding: 0 }}>
