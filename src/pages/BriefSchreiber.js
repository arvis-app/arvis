...
function buildPrompt(mode, style, length, input) {
  ...
  if (mode === 'korrektur') return `Korrigiere und überarbeite den folgenden medizinischen Text im Stil eines deutschen Arztbriefs.\n\nREGELN:\n1. ${ph}\n2. FACHBEGRIFFE: Einfache oder umgangssprachliche Formulierungen aktiv in korrektes medizinisches Fachvokabular übersetzen. Beispiele: "Brustschmerz" → "retrosternale Schmerzen" oder "thorakale Beschwerden", EKG-Befunde anatomisch präzisieren (z.B. "ST-Hebungen V1–V3" → "ST-Streckenhebungen in den anteroseptalen Ableitungen V1–V3"), Vorerkrankungen korrekt benennen.\n3. ABSÄTZE: Inhaltlich zusammengehörige Abschnitte (z.B. Anamnese, Befunde, Therapie, Verlauf) in eigene Absätze gliedern — getrennt durch eine Leerzeile. Innerhalb eines Absatzes fließende Sätze mit logischen Übergängen, nicht als aneinandergereihte Einzelsätze.\n4. NUR was im Text steht: Keine neuen Diagnosen, Befunde, Empfehlungen oder Abschnitte hinzufügen.\n5. Redundanzen entfernen — nur die präziseste Formulierung behalten.\n\nText:\n${input}`
