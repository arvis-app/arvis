...
function buildPrompt(mode, style, length, input) {
  ...
  if (mode === 'korrektur') return `Schreibe den folgenden medizinischen Text professionell um — so wie er in einem deutschen Arztbrief stehen würde.\n\nREGELN:\n1. ${ph}\n2. Rechtschreibung, Grammatik und medizinische Fachbegriffe korrigieren (z.B. "Brustschmrz" → "Brustschmerzen", "art. Hypertonie" bleibt).\n3. Stil: professionell, sachlich, medizinisch-präzise.\n4. FORMAT: Passe das Format dem Input an. Kurze Stichpunkte → kompakter Absatz. Längerer strukturierter Text → Struktur beibehalten und glätten.\n5. NUR was im Text steht: Keine neuen Diagnosen, Empfehlungen, Abschnitte oder Inhalte hinzufügen. Keine Abschnitte erzwingen (kein "OP:", kein "Empfehlungen:" wenn nicht im Input).\n6. Redundanzen und Wiederholungen entfernen — nur die präziseste Formulierung behalten.\n\nText:\n${input}`
