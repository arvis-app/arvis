...
function buildPrompt(mode, style, length, input) {
  ...
  if (mode === 'korrektur') return `Überarbeite den folgenden medizinischen Text zu einem vollständigen deutschen Arztbrief in echter Prosa.\n\nREGELN:\n1. ${ph}\n2. FACHBEGRIFFE: Umgangssprachliche Formulierungen in korrektes medizinisches Fachvokabular übersetzen (z.B. "Brustschmerz" → "retrosternale Schmerzen", EKG-Befunde anatomisch präzisieren).\n3. SATZSTIL — WICHTIG: Keine Aufzählungen, keine Wertelisten. Alle Informationen in vollständige, verbundene Sätze einbauen. Typische Arztbrief-Konstruktionen verwenden:\n   - Laborwerte: "Laborchemisch zeigten sich… mit einem CRP von … als Ausdruck einer…"\n   - Befunde: "Die körperliche Untersuchung ergab… Bei der Palpation fand sich…"\n   - Bildgebung: "Sonographisch stellte sich… dar. Es zeigte sich…"\n   - Therapie: "Es erfolgte… Zusätzlich wurde… eingeleitet."\n   - Übergänge zwischen Sätzen: "Zudem", "Darüber hinaus", "Im Verlauf", "Ergänzend".\n4. ABSÄTZE: Anamnese, Befunde, Labor, Bildgebung, Diagnose, Therapie je in eigenen Absatz — getrennt durch Leerzeile.\n5. NUR was im Text steht: Keine neuen Diagnosen, Befunde oder Empfehlungen hinzufügen.\n6. Redundanzen entfernen.\n\nText:\n${input}`
