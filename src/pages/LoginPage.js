      ...
      <div className="login-left">
        ...
        <div className="login-features">
          {[
            ...
            { icon: <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>, text: '100% DSGVO-konform · Keine Patientendaten' },
          ].map((f, i) => (
          ...
          {tab === 'register' && (
            <div>
              ...
              <div className="dsgvo-note">
                <span></span>
                <span>Mit der Registrierung stimmen Sie unseren <a href="#" style={{color:'var(--orange)'}}>AGB</a> und der <a href="#" style={{color:'var(--orange)'}}>Datenschutzerklärung</a> zu. Keine Patientendaten werden gespeichert.</span>
              </div>
