...
const S = {
  ...
  h3:      { fontSize: 15, fontWeight: 600, marginTop: 20, marginBottom: 8, color: '#1a1a1a' },
  ...
  caps:    { fontSize: 14, lineHeight: 1.7, color: '#333', marginBottom: 12, fontWeight: 600 },
  note:    { background: '#fff8f0', border: '1px solid #ffe4c4', borderRadius: 8, padding: '12px 16px', fontSize: 13, color: '#b45309', marginTop: 12, marginBottom: 12 },
